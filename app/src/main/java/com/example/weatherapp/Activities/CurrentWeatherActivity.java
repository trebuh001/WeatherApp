...
import com.example.weatherapp.Interfaces.CurrentWeatherInterface;
...
public class CurrentWeatherActivity extends AppCompatActivity {
    ...
    private String city_name,country_name;
    ...
    private CurrentWeatherInterface weather;
    @Override
    ...
    private void initializeCurrentWeatherActivity()
    {
        Retrofit retrofit= new Retrofit.Builder()
                ...
                .build();
        weather= retrofit.create(CurrentWeatherInterface.class);
    }
    private void getAll()
    {
